       ...
       <div className="relative hidden lg:flex flex-col items-center justify-center bg-muted text-center p-8">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-black/20" />
         <div className="relative z-10 max-w-md">
            <h1 className="text-3xl font-bold font-headline text-white">Join a Community of Learners</h1>
            <p className="text-white/80 mt-4">
                Create your account to start exploring live classes, engaging quizzes, and collaborative projects.
            </p>
        </div>
       </div>
      ...
      <div className="flex items-center justify-center p-4 z-10">
        <Card className="w-full max-w-md mx-auto shadow-none border-none lg:shadow-xl lg:border bg-transparent lg:bg-card text-card-foreground lg:text-card-foreground backdrop-blur-lg lg:backdrop-blur-none bg-white/10 lg:bg-white rounded-xl">
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-2xl font-headline text-white lg:text-current">Create an Account</CardTitle>
            <CardDescription className="text-white/80 lg:text-muted-foreground">Join our community to start learning.</CardDescription>
          </CardHeader>
          <CardContent>
            <SignupForm />
          </CardContent>
